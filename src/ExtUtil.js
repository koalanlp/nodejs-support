 ...
 */
export const HanFirstList = Object.freeze(_.range(0x1100, 0x1112 + 1).map((x) => String.fromCharCode(x)));
 ...
 */
export const HanSecondList = Object.freeze(_.range(0x1161, 0x1175 + 1).map((x) => String.fromCharCode(x)));
 ...
 */
export const HanLastList = Object.freeze(_.range(0x11A7, 0x11C2 + 1).map((x) => {
    if (x === 0x11A7) return undefined;
 ...
 */
export const ChoToJong = Object.freeze(new Map([
    ['\u1100', '\u11A8'], // ㄱ
    ['\u1101', '\u11A9'], // ㄲ
    ['\u1102', '\u11AB'], // ㄴ
    ['\u1103', '\u11AE'], // ㄷ
