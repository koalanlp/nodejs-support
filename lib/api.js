    ...
    _createClass(Parser, [{
        ...
        value: function parse(paragraph) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (_this3.tagger && !isSentences) {
                    _this3.tagger.tag(paragraph, function (taggerErr, result) {
                        if (taggerErr) reject(taggerErr);else _this3.parser.parse(result, function (err, parsed) {
...
var initialize = exports.initialize = function initialize(obj) {
    ...
    return new Promise(function (resolve, reject) {
        require('./koalanlp/javainit').initializer(obj).catch(reject).then(function (jvm) {
            java = jvm;
