...
var Tagger = exports.Tagger = function () {
    ...
    _createClass(Tagger, [{
        ...
        key: "tagSync",
        value: function tagSync(paragraph) {
            var _this2 = this;

            if (Array.isArray(paragraph)) {
                return paragraph.map(function (sent) {
                    return _this2.tagger.tagSentenceSync(sent);
                });
            } else {
        ...
        value: function tagSentence(sentence) {
            ...
            return new Promise(function (resolve, reject) {
                _this3.tagger.tagSentence(sentence, function (err, result) {
        ...
        key: "tagSentenceSync",
        value: function tagSentenceSync(sentence) {
    ...
    _createClass(Parser, [{
                ...
                if (isSentence) {
                    ...
                    try {
                        if (isList) {
                            ...
                            if (_this4.tagger) {
                                target = paragraph.map(function (sent) {
                                    return _this4.tagger.tagSync(sent);
                                });
                            } else {
                                target = paragraph;
                            }
                            ...
                            resolve(target.map(function (sent) {
                                return convertSentence(_this4.parser.parseSync(sent));
                            }));
                        } else {
                            if (_this4.tagger) {
                                target = _this4.tagger.tagSync(paragraph);
                            } else {
                                target = paragraph;
                            }
        ...
        value: function parseSentence(sentence) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (_this5.tagger && !isSentence) {
                    _this5.tagger.tagSentence(sentence, function (taggerErr, result) {
                        if (taggerErr) reject(taggerErr);else _this5.parser.parse(result, function (err, parsed) {
                            if (err) reject(err);else resolve(convertSentence(parsed));
                        });
                    });
                } else if (isSentence) {
                    var target = sentence.reference;
                    _this5.parser.parse(target, function (err, parsed) {
                        if (err) reject(err);else resolve(convertSentence(parsed));
                    });
        ...
        key: "parseSync",
        value: function parseSync(paragraph) {
            var _this6 = this;
            ...
            if (isSentence) {
                ...
                if (isList) {
                    ...
                    if (this.tagger) {
                        target = paragraph.map(function (sent) {
                            return _this6.tagger.tagSync(sent);
                        });
                    } else {
                        target = paragraph;
                    }

                    return target.map(function (sent) {
                        return convertSentence(_this6.parser.parseSync(sent));
                    });
                } else {
                    if (this.tagger) {
        ...
        key: "parseSentenceSync",
        value: function parseSentenceSync(sentence) {
            var isSentence = sentence instanceof _data.Sentence;
            ...
            } else throw new Error("A raw string cannot be parsed as a single sentence without a tagger!");
        }
    }]);
...
var SentenceSplitter = exports.SentenceSplitter = function () {
    ...
    _createClass(SentenceSplitter, [{
        ...
        value: function sentences(paragraph) {
            ...
            return new Promise(function (resolve, reject) {
                _this7.splitter.sentences(paragraph, function (err, parsed) {
        ...
        key: "sentencesSync",
        value: function sentencesSync(paragraph) {
        ...
        value: function sentencesSync(paragraph) {
            ...
            return converter(java.callStaticMethodSync("kr.bydelta.koala.util.SentenceSplitter", "apply", paragraph.reference));
        }
    }]);
...
var Dictionary = exports.Dictionary = function () {
    ...
    _createClass(Dictionary, [{
        ...
        value: function addUserDictionary(morph, tag) {
            ...
            return new Promise(function (resolve, reject) {
                if (isMArray) {
                    ...
                    _this8.dict.addUserDictionary(tuples, function (err) {
                        if (err) reject(err);else resolve(true);
                    });
                } else {
                    var posTag = java.callStaticMethodSync("kr.bydelta.koala.POS", "withName", tag);
                    _this8.dict.addUserDictionary(morph, posTag, function (err) {
                        if (err) reject(err);else resolve(true);
                    });
                }
            });
        ...
        key: "addUserDictionarySync",
        value: function addUserDictionarySync(morph, tag) {
            var isMArray = Array.isArray(morph);
            var isTArray = Array.isArray(tag);
        ...
        value: function contains(word) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this9.dict.contains(word, posSet, function (err, result) {
        ...
        value: function getNotExists(onlySystemDic) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this10.dict.getNotExists(onlySystemDic, wordSeq, function (err, notExists) {
        ...
        value: function importFrom(other, filterFn, fastAppend) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this11.dict.importFrom(other.dict, tagSet, fastAppend, function (err) {
                    if (err) reject(err);else resolve(true);
                });
            });
        }
        ...
        value: function baseEntriesOf(filterFn) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this12.dict.baseEntriesOf(tagSet, function (err, entries) {
                    if (err) reject(err);else {
